...
module.exports = {
    ...
    rules: {
        ...
        // http://eslint.cn/docs/developer-guide/shareable-configs 中文文档
        ...
        'no-obj-calls': 0, // 不要将全局对象的属性作为函数调用
        ...
        'eqeqeq': 1, // 始终使用 === 替代 ==
        'space-infix-ops': 1, // 字符串拼接操作符之间要留空格
        ...
        'no-return-assign': 1, // return 语句中的赋值必需有括号包裹
